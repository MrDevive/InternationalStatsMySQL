...
*(После установки и настройки плагин автоматически создаёт таблицы в вашей базе данных. Ниже приведён пример данных из таблицы `stats_players`)*

| Игрок (UUID).  |        Ник.       | Время игры (мин) | Первый вход | Последний вход |
| :---           | :---              | :--- | :--- | :--- |
| `069a79f4-...` |   **Devive**.     | 1420 | 2026-04-20 | 2026-04-24 15:32 |
| `a1b2c3d4-...` | **ExamplePlayer** |  55  | 2026-04-23 | 2026-04-24 10:15 |
